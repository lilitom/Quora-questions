...
########################################
## save the train data and the test data
########################################
np.save('data_1_train.npy',data_1_train)
np.save('data_2_train.npy',data_2_train)
np.save('leaks_train.npy',leaks_train)
np.save('labels_train.npy',labels_train)
np.save('data_1_val.npy',data_1_val)
np.save('data_2_val.npy',data_2_val)
np.save('leaks_val.npy',leaks_val)
np.save('labels_val.npy',labels_val)
np.save('weight_val.npy',weight_val)
np.save('test_data_1.npy',test_data_1)
np.save('test_data_2.npy',test_data_2)
np.save('test_leaks.npy',test_leaks)
